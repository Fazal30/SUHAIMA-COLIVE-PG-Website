...
const Home = () => {
  ...
  <div className="relative z-10 text-center px-4 max-w-5xl">
    ...
    >
      <Button className="px-10 py-5 text-lg rounded-full bg-gradient-to-r from-indigo-600 to-purple-600 shadow-[0_10px_40px_rgba(99,102,241,0.5)] hover:scale-110 transition-all">
        Book Your Stay
      </Button>
